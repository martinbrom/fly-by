...
@section('body')
    ...
    <div class="container mb-5">
        ...
        <div class="order-info">
            ...
            <p class="order-duration"><b>Doba:</b> {{ $order->duration }} sekund
                ({{ round($order->duration / 3600, 1) }} hodin)</p>
        ...
        <div class="order-aircraft-info row">
            @if(!empty($order->aircraftAirport->aircraft))
                ...
                <div class="col-sm-6">
                    ...
                    <p class="aircraft-range"><b>Dolet letadla:</b> {{ $order->aircraftAirport->aircraft->range }} km
                    </p>
                    <p class="aircraft-speed"><b>Rychlost letadla:</b> {{ $order->aircraftAirport->aircraft->speed }}
                        km/h</p>
                    <p class="aircraft-cost"><b>Cena za provoz
                            letadla:</b> {{ $order->aircraftAirport->aircraft->cost }} CZK/km</p>
                </div>
            @else
                <div class="col-sm-12">
